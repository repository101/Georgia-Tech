...
ksize = (1, 1)  # size of the window w(u, v)
...
Ix = [[0,1,1],[1,0,1],[0,1,0]]
Iy = [[0,1,0],[1,0,1],[1,1,0]]
...
R2 = (M_Ixx * M_Iyy - M_Ixy * M_Ixy) - kappa * (alpha * (M_Ixx + M_Iyy)**2)
print("Here is R:\n ", R)
print()
print("Here is R:\n ", R)
...
# the angles 0 and 180 map to bin 0; 160 and 340 map to bin 8; etc. 
# You can also try signed gradients,which maps the 9 bins at 40 degree increments around the
# whole 360 degree circle; this is usually a tunable option. 

# For simplicity, this step
